    ...
    const textstudent = data.map((item, index, array) => {
      return (
        <tr className="list" key={index}>
          ...
          <td className="td-btn">
            <button type="button" className="btn" style={{ width: "80px" }} onClick={this.alterData}>修改</button>
            <button type="button" className="btn" style={{ width: "80px" }}>取消</button>
            <button type="button" className="btn" style={{ width: "80px" }}>接受</button>
          </td>
        </tr>
      );
    })
      ...
      return (
        <form className="form"  >
          ...
          <div className="list">
            ...
            <textarea className="input" value={item.TeacherRemasks} style={{ height: "100px" }}></textarea>
          </div>
          <div className="list">
        ...
        <div className="Studentdata">
          <div className="title">
            <table className="table">
              <thead>
                <th className="tabletitle" colspan="7"><h2>輔導老師預約系統-接受預約</h2></th>
                ...
                <tr>
                  ...
                  <th><Link to="/CounselorTeacherReservation3/1">預約完成</Link></th>
                </tr>
                <tr className="list">
                  <th>編號</th>
                  <th>班級</th>
