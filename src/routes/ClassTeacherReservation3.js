        ...
        <div className="Studentdata">
          <div className="title">
            <table className="table">
              <thead>
                <th className="tabletitle" colspan="7"><h2>班導預約系統-指派完成</h2></th>
                ...
                <tr>
                  <th colspan="2"><Link to="/ClassTeacherReservation1/1">未指派</Link></th>
                  <th colspan="1"><Link to="/ClassTeacherReservation2/1">正在指派</Link></th>
                  <th>指派完成</th>
                </tr>
                <tr className="list">
                  <th>編號</th>
