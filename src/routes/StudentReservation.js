                            ...
                            <div className="StudentReservation wrap">
                                <form className="StudentReservation form">
                                    ...
                                    <div className="StudentReservation list">
                                        <span className="StudentReservation list-text">姓名：</span>
                                    </div>
                                    <div className="StudentReservation list">
                                    ...
                                    <div className="StudentReservation list">
                                        <span className="StudentReservation list-text">手機</span>
                                    ...
                                    <div className="StudentReservation list">
                                        <span className="StudentReservation red-dot">*</span>
                                        <span className="StudentReservation list-text">預約日期1</span>
                                        <select className="StudentReservation input columns_3">
                                            <option>年</option>
                                    ...
                                    <div className="Register list">
                                        ...
                                        <span className="Register list-text">預約日期2</span>
                                        <input className="StudentReservation input" type="date"></input>
                                    </div>
                                    <div className="Register list">
                                        <span className="Register red-dot">*</span>
                                        <span className="Register list-text">預約時間2</span>
